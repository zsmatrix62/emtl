...
**方法：**
- `get_client(username, password, ttl=None)` - 获取客户端（自动缓存）
...
manager = ClientManager(DillSerializer(), default_ttl=3600)
...
| `ClientManager.default_ttl` | `7200` 秒 (2 小时) |
